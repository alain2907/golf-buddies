        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '12px' }}>
            ...
            <h1 style={{ fontSize: '32px', fontWeight: 'bold', color: '#111827', margin: 0 }}>
              Crée ta première annonce de golf !
            </h1>
          </div>

          <p style={{ fontSize: '18px', color: '#6b7280', marginBottom: '20px' }}>
            Suis ces 6 étapes simples pour publier ton événement et trouver des partenaires de golf.
          </p>
          ...
          <div style={{
            ...
            <p style={{ margin: 0, color: '#1e40af' }}>
              <span style={{ fontWeight: '600' }}>Astuce :</span> Plus tu donnes de détails, plus tu attires les bons golfeurs !
            </p>
          </div>
        </div>
      </div>
...
function HowToCreatePageOriginal() {
  const router = useRouter()
