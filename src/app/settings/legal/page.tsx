        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-xl border border-golf-fairway/20">
          <div className="prose prose-gray max-w-none p-8">
            ...
            <div className="bg-gray-50 p-4 rounded-lg mb-6">
              <p className="mb-2">Le site <strong>Golf Buddies</strong> est édité par :</p>
            ...
            <p className="mb-6">
              La mise en place de liens hypertextes vers le site Golf Buddies nécessite une autorisation préalable écrite de CORBERA 10 SAS.
            </p>
